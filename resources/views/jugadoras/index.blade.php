...
<div class="container">
  ...
  <p class="mb-4">
    <a href="{{ route('jugadoras.create') }}" class="bg-blue-600 text-white px-3 py-2 rounded">{{ __('Nova Jugadora') }}</a>
  </p>
    ...
    @foreach ($jugadoras as $jugadora)
      <article class="card">
        <header class="card__header">
          <h2 class="card__title">{{ __('Dorsal :numero', ['numero' => $jugadora->dorsal]) }}</h2>
