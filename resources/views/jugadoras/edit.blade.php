...
@section('content')
  @section('content')
    <div class="container">
      <h1 class="title">{{ __('Editar jugadora') }} ID: {{ $jugadora->id }}</h1>
      ...
      <form action="{{ route('jugadoras.update', $jugadora) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="form-group">
          ...
          <input type="number" name="dorsal" id="dorsal" value="{{ old('dorsal', $jugadora->dorsal) }}" class="form-input">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="date" name="data_naixement" id="data_naixement"
            value="{{ old('data_naixement', $jugadora->data_naixement) }}" class="form-input">
        </div>
        ...
        <div class="form-group">
          ...
          @if($jugadora->foto)
            <div class="mb-2">
              <img src="{{ asset('storage/' . $jugadora->foto) }}" alt="Foto actual" class="avatar">
            </div>
          @endif
        ...
        <div class="flex gap-2 pt-2">
          <button type="submit" class="btn--submit">{{ __('Actualitzar Jugadora') }}</button>
