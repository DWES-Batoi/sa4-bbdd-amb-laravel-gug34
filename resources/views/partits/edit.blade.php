...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">{{ __('Editar Partit Jornada: :jornada', ['jornada' => $partit->jornada]) }}</h1>
    ...
    <form action="{{ route('partits.update', $partit) }}" method="POST" class="space-y-4 bg-white p-6 rounded shadow">
      ...
      <div class="flex gap-2 pt-2">
          <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">{{ __('Actualitzar Partit') }}</button>
